...
<head>
	...
	<title>Handled Kitchen Request | <?php echo $system_title; ?></title>
        ...
        <div class="content">
			...
			<div class="row">
					 <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Handled Kitchen Request</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table id="example1"class="table table-hover table-striped">
                                    ...
                                    <tbody>
									  <?php
											$count = 1; 
											$notarray = database::getInstance()->select_kitchen_handled();
